# Parcial de algoritmos II

# Miembros: Robert Rivas y Jesus Ogliastri 

# En esta presentación, abordamos la implementación de un grafo  
# utilizando listas de adyacencia en Python.Esta estructura de datos nos 
# permite representar conexiones entre nodos (vértices) y los pesos de los 
# arcos que los unen, como el coste de ida entre distintos puntos de una ciudad.
